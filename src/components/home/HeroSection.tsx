  ...
  return (
    <div className="relative w-full mt-6">
      ...
      >
                ...
                <CardContent className="flex items-center justify-center h-full p-0 w-full">
                  ...
                  >
                    ...
                    <div className="relative z-10 w-full h-full flex items-start flex-col justify-center pl-[50px] bg-[#00000011] gap-[5px]">
                      <h1 className="text-[20px] sm:text-[30px] lg:text-[60px] font-[700] text-green-600">
                      ...
                      <Link
                        to={"/"}
                        className="px-[20px] border-[1px] border-green-600 py-[5px] text-white mt-[20px]"
                      >
                        Shop Now
                      </Link>
                    </div>
        ...
        <CarouselPrevious className="absolute left-4 top-1/2 transform -translate-y-1/2 text-green-600 bg-black bg-opacity-50 p-2 rounded-full cursor-pointer hover:bg-opacity-75 transition-opacity duration-300">
          &#9664;
        </CarouselPrevious>
        <CarouselNext className="absolute right-4 top-1/2 transform -translate-y-1/2 text-green-600 bg-black bg-opacity-50 p-2 rounded-full cursor-pointer hover:bg-opacity-75 transition-opacity duration-300">
          &#9654;
        </CarouselNext>
      </Carousel>
    </div>
